...
right_UF_FA_ExtBeh <- function(right_UF){
  ...
  LinModel <- lm(Mean_FA~CB68EPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
...
right_UF_FA_ExtBeh2 <- function(right_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68EPTOT + age_scan + GENDER + CB68IPTOT + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_FA_ExtBeh <- function(right_UF){
  ...
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68EPTOT + CB68EPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_MD_ExtBeh <- function(right_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68EPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_MD_ExtBeh2 <- function(right_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68EPTOT + age_scan + GENDER + Overall_DWI_Noise + CB68IPTOT + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_MD_ExtBeh_diag <- function(right_UF){
  ...
  cat("Printing linear model \n")
  right_UF$clin_diagnosis[right_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68EPTOT + CB68EPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_FA_IntBeh <- function(right_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_FA_IntBeh2 <- function(right_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + CB68EPTOT + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_FA_IntBeh_diag <- function(right_UF){
  ...
  cat("Printing linear model \n")
  right_UF$clin_diagnosis[right_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_FA~CB68IPTOT + CB68IPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_MD_IntBeh <- function(right_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_MD_IntBeh2 <- function(right_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + CB68EPTOT + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
right_UF_MD_IntBeh_diag <- function(right_UF){
  ...
  cat("Printing linear model \n")
  right_UF$clin_diagnosis[right_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68IPTOT + CB68IPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = right_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_ExtBeh <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68EPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_ExtBeh2 <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68EPTOT + age_scan + GENDER + CB68IPTOT + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_ExtBeh_diag <- function(left_UF){
  ...
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68EPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_ExtBeh_gender <- function(left_UF){
  ...
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68EPTOT*GENDER + age_scan + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_ExtBeh <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68EPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_ExtBeh2 <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68EPTOT + age_scan + GENDER + Overall_DWI_Noise + CB68IPTOT + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_ExtBeh_diag <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68EPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_ExtBeh_age <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68EPTOT*age_scan + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_ExtBeh_gender <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68EPTOT*GENDER + age_scan + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_IntBeh <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_IntBeh2 <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_FA~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + CB68EPTOT + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_IntBeh_diag <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_FA~CB68IPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_IntBeh <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_FA~CB68IPTOT*age_scan + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_FA_IntBeh_gender <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_FA~CB68IPTOT*GENDER + age_scan + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_IntBeh <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_IntBeh2 <- function(left_UF){
  ...
  library(olsrr)
  cat("Printing linear model \n")
  LinModel <- lm(Mean_MD~CB68IPTOT + age_scan + GENDER + Overall_DWI_Noise + CB68EPTOT + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_IntBeh <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68IPTOT*clin_diagnosis + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_IntBeh_age <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68IPTOT*age_scan + age_scan + GENDER + Overall_DWI_Noise + ST_MED_6M, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
...
left_UF_MD_IntBeh_gender <- function(left_UF){
  ...
  cat("Printing linear model \n")
  left_UF$clin_diagnosis[left_UF$clin_diagnosis == "GAD"] <- NA
  LinModel <- lm(Mean_MD~CB68IPTOT*GENDER + age_scan + Overall_DWI_Noise, data = left_UF, na.action = na.omit)
  print(summary(LinModel))
  cat("Printing beta coefficient values \n")
  print(lm.beta(LinModel))
  cat("printing outlier test \n")
