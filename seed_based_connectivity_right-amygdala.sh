...
#Step 3: Prepare function to obtain the functional correlation (connectivity) between the right amygdala seed and cortical vertices 
ciftify_seed_corr() {
      singularity exec \
      -H ${sing_home} \
      -B ${input}:/input \
...
--outputname /output/`index`.RA.dscalar.nii \         #this is the output file name 
--fisher-z \                                          #providing the z scores
--roi-label 54 \                                      #number of the amygdala ROI
